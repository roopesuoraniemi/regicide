...
As described [here](https://discord.com/developers/docs/activities/building-an-activity#step-4-running-your-app-locally-in-discord), you can use ngrok for local development with the configured Cloud Endpoint (`https://dismount-drudge-sixtieth.ngrok-free.dev`).
To run your app locally, run the following from this directory:

```
pnpm install # only need to run this the first time
pnpm dev
pnpm tunnel # runs ngrok http 3000 --url https://dismount-drudge-sixtieth.ngrok-free.dev
```
